package getawaygo_project.getawaygo_backend.configuration.isauthenticated;
...
public class IsAuthenticatedAspect {
    ...
    @Pointcut("@annotation(getawaygo_project.getawaygo_backend.configuration.isauthenticated.IsAuthenticated)")
    public void annotatedMethod() {
    }

    @Pointcut("@within(getawaygo_project.getawaygo_backend.configuration.isauthenticated.IsAuthenticated)")
